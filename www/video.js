...
/**
 * Video对象提供视频播放能力，支持的视频格式仅限于系统播放器支持的格式，依赖File扩展(Android) </br>
 * 请注意：</br>
 ...
 * @class Video
 * @constructor
 * @param {String} src 源文件路径，可以是本地文件（兼容cdvfile://协议，file://等，但不支持file:///android_asset/协议，由于第三方播放器无法访问asset下文件），也可以是网络url
...
Video.prototype.play = function() {
    exec(this.successCallback, this.errorCallback, "Video", "play", [this.src]);
};
